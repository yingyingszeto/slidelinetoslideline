...
var avadaLanguageVars={"language_flag":"french"};jQuery(document).ready(function(){""!==avadaLanguageVars.language_flag&&jQuery(".search-field, .searchform").each(function(){jQuery(this).find('input[name="lang"]').length||jQuery(this).parents(".searchform").find('input[name="lang"]').length||jQuery(this).append('<input type="hidden" name="lang" value="'+avadaLanguageVars.language_flag+'"/>')})});
